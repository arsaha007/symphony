...
func createSolutionVersionVendor() SolutionVersionVendor {
...
func TestSolutionVersionEndpoints(t *testing.T) {
...
func TestSolutionVersionGetInstances(t *testing.T) {
	vendor := createSolutionVersionVendor()
...
func TestSolutionVersionApply(t *testing.T) {
	vendor := createSolutionVersionVendor()
	deployment := createDeployment2Mocks1Target(uuid.New().String())
	data, _ := json.Marshal(deployment)
	resp := vendor.onApplyDeployment(v1alpha2.COARequest{
...
func TestSolutionVersionRemove(t *testing.T) {
	vendor := createSolutionVersionVendor()
	deployment := createDeployment2Mocks1Target(uuid.New().String())
	data, _ := json.Marshal(deployment)
	resp := vendor.onApplyDeployment(v1alpha2.COARequest{
...
func TestSolutionVersionReconcileDocker(t *testing.T) {
...
func TestSolutionVersionReconcile(t *testing.T) {
	var summary model.SummarySpec
	vendor := createSolutionVersionVendor()
	...
	deployment.SolutionVersion.Spec.Components = append(deployment.SolutionVersion.Spec.Components, model.ComponentSpec{Name: "c", Type: "mock"})
	...
	deployment.SolutionVersion.Spec.Components = deployment.SolutionVersion.Spec.Components[1:]
...
func TestSolutionVersionQueue(t *testing.T) {
	vendor := createSolutionVersionVendor()
...
func TestSolutionVersionQueueInstanceUpdate(t *testing.T) {
	vendor := createSolutionVersionVendor()
...
func TestSolutionVersionQueueTargetUpdate(t *testing.T) {
	vendor := createSolutionVersionVendor()
	vendor.Context = &contexts.VendorContext{}
	pubSubProvider := memory.InMemoryPubSubProvider{}
	pubSubProvider.Init(memory.InMemoryPubSubConfig{Name: "test"})
